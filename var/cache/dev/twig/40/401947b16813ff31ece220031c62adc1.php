            ...
            <div class=\"wide-block pb-2 pt-2\">
                    ...
                    <div class=\"custom-file-upload\" id=\"fileUpload1\">
                        ...
                        <label for=\"fileuploadInput\">
                            <span class=\"p-0 d-flex justify-content-center align-items-center\">
                            ";
        // line 188
        if ((twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "imgprofile", [], "any", true, true, false, 188) && (twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 188, $this->source); })()), "imgprofile", [], "any", false, false, false, 188) != ""))) {
            // line 189
            echo "                                <img src=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 189, $this->source); })()), "imgprofile", [], "any", false, false, false, 189), "html", null, true);
            echo "\" alt=\"Photo de profil\" class=\"w-100\" style=\"opacity: 0.2;\">
                            ";
        }
        // line 191
        echo "                                <strong class=\"";
        if ((twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "imgprofile", [], "any", true, true, false, 191) && (twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 191, $this->source); })()), "imgprofile", [], "any", false, false, false, 191) != ""))) {
            echo "position-absolute text-dark";
        }
        echo "\">
                                    <ion-icon name=\"cloud-upload-outline\" class=\"";
        // line 192
        if ((twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "imgprofile", [], "any", true, true, false, 192) && (twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 192, $this->source); })()), "imgprofile", [], "any", false, false, false, 192) != ""))) {
            echo "text-dark";
        }
        echo "\"></ion-icon>
...
";
    ...
    {
        return array (  340 => 192,  333 => 191,  327 => 189,  325 => 188,  303 => 169,  281 => 150,  259 => 131,  237 => 112,  215 => 93,  199 => 79,  193 => 78,  185 => 75,  182 => 74,  176 => 73,  172 => 71,  169 => 70,  165 => 69,  159 => 68,  156 => 67,  153 => 66,  149 => 65,  135 => 54,  122 => 44,  109 => 34,  96 => 24,  86 => 17,  78 => 12,  68 => 4,  58 => 3,  35 => 1,);
    }
        ...
        <div class=\"section full mt-2 mb-2 form-group\">
            ...
            <div class=\"wide-block pb-2 pt-2\">
                    ...
                    <div class=\"custom-file-upload\" id=\"fileUpload1\">
                        ...
                        <label for=\"fileuploadInput\">
                            <span class=\"p-0 d-flex justify-content-center align-items-center\">
                            {% if profile.imgprofile is defined and profile.imgprofile != \"\" %}
                                <img src=\"{{profile.imgprofile}}\" alt=\"Photo de profil\" class=\"w-100\" style=\"opacity: 0.2;\">
                            {% endif %}
                                <strong class=\"{% if profile.imgprofile is defined and profile.imgprofile != \"\" %}position-absolute text-dark{% endif %}\">
                                    <ion-icon name=\"cloud-upload-outline\" class=\"{% if profile.imgprofile is defined and profile.imgprofile != \"\" %}text-dark{% endif %}\"></ion-icon>
                                    <i>Change ta photo de profil</i>
                                </strong>
                            </span>
                        </label>
