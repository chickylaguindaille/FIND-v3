...
\$(document).ready(function () {
    ...
    function searchAssociations() {
        ...
        ";
        // line 43
        if (((isset($context["typepage"]) || array_key_exists("typepage", $context) ? $context["typepage"] : (function () { throw new RuntimeError('Variable "typepage" does not exist.', 43, $this->source); })()) == "homepage")) {
            // line 44
            echo "            var auto_complete = new Autocomplete(document.getElementById('findinput'), {
        ...
        echo "
            \$.ajax({
                ...
                success: function (data) {
                        ";
        // line 57
        if (((isset($context["typepage"]) || array_key_exists("typepage", $context) ? $context["typepage"] : (function () { throw new RuntimeError('Variable "typepage" does not exist.', 57, $this->source); })()) == "homepage")) {
            // line 58
            echo "
                            console.log(data);
    ...
    function redirectAutocomplete() {
        ...
        var redirectUrl = \"";
        // line 110
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("corporation_with_id"), "js", null, true);
        echo "\";
  ...
  <script type=\"module\">
    ...
    {
        return array (  196 => 110,  180 => 96,  175 => 93,  138 => 58,  136 => 57,  128 => 51,  119 => 44,  117 => 43,  108 => 37,  101 => 32,  96 => 30,  91 => 29,  86 => 26,  84 => 25,  70 => 14,  66 => 13,  62 => 12,  58 => 11,  54 => 10,  43 => 1,);
    }
...
\$(document).ready(function () {
  ...
  </script>", "find/corporations/corporations.js.twig", "/Applications/MAMP/htdocs/FIND-v3/templates/find/corporations/corporations.js.twig");
    }
}
