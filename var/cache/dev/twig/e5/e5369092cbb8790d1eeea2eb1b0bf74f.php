...
class __TwigTemplate_99be40ae5bc62f11326717bbc0e8c4d9 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (((isset($context["typepage"]) || array_key_exists("typepage", $context) ? $context["typepage"] : (function () { throw new RuntimeError('Variable "typepage" does not exist.', 42, $this->source); })()) != "towns")) {
            ...
            // line 47
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["listes"]) || array_key_exists("listes", $context) ? $context["listes"] : (function () { throw new RuntimeError('Variable "listes" does not exist.', 47, $this->source); })()), 0, [], "array", false, false, false, 47), "assotype", [], "array", false, false, false, 47)));
            ...
            // line 57
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["listes"]) || array_key_exists("listes", $context) ? $context["listes"] : (function () { throw new RuntimeError('Variable "listes" does not exist.', 57, $this->source); })()), 0, [], "array", false, false, false, 57), "hats", [], "array", false, false, false, 57)));
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                // line 58
                echo "                                    <option value=\"";
                echo twig_escape_filter($this->env, $context["name"], "html", null, true);
    ...
    {
        return array (  229 => 92,  222 => 86,  213 => 81,  204 => 77,  199 => 74,  189 => 69,  183 => 68,  177 => 67,  168 => 60,  153 => 58,  149 => 57,  140 => 50,  125 => 48,  121 => 47,  115 => 43,  112 => 42,  107 => 39,  90 => 37,  86 => 36,  79 => 31,  70 => 18,  64 => 17,  58 => 13,  56 => 12,  43 => 1,);
    }
    ...
    public function getSourceContext()
    {
        return new Source("            <!-- MODAL FILTRE -->
                        ...
                        <div class=\"form-group col-12\">
                            ...
                            <select name=\"town\" class=\"form-select\" id=\"townfilter\" >
                                ...
                                {% for town in towns|sort %}
                                    <option id=\"{{asset(town.blason)}}\" value=\"{{town.name}}\" {% if allfilter.town is defined and allfilter.town == town.name %}selected{% endif %}>{{town.name}}</option>
                                {% endfor %}
                            </select>
                        </div>
                    {% endif %}
                        ...
                        <div class=\"form-group col-12\">
                            ...
                            <select name=\"typeasso\" class=\"form-select\" id=\"typefilter\" >
                                ...
                                {% for name in listes[0]['assotype']|sort %}
                                    <option value=\"{{name}}\" {% if allfilter.typeasso is defined and allfilter.typeasso == name %}selected{% endif %}>{{name}}</option>
                                {% endfor %}
                            </select>
                        </div>
            ...
            {# FIN MODAL FILTRE #}", "inc/tri_filtre/filtre.html.twig", "/opt/lampp/htdocs/FIND-v3/templates/inc/tri_filtre/filtre.html.twig");
    }
}
