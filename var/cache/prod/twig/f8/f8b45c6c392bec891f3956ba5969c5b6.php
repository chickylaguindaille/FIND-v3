...
class=\"form-image mt-3 mb-3\">
        ...
        if ((array_key_exists("error", $context) && (($context["error"] ?? null) != ""))) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["error"] ?? null), "messageData", [], "any", false, false, false, 28), 0, [], "any", false, false, false, 28), "html", null, true);
            echo "</div
                ";
        }
        // line 30
...
";
    ...
    {
        return array (  121 => 61,  114 => 55,  109 => 53,  84 => 30,  78 => 28,  76 => 27,  67 => 21,  50 => 6,  46 => 5,  35 => 1,);
    }
